...
export default defineMcp({
  name: "my-beauty-shelf",
  title: "My Beauty Shelf",
  version: "0.1.0",
  instructions:
    "Tools for My Beauty Shelf, a cross-brand beauty shelf tracker. Use `list_products` to see what the user owns with freshness status, `add_product` and `update_product` to maintain the shelf, `get_skin_profile` for skin type/concerns/undertone, and `routine_check` for ingredient conflicts and expiring products.",
